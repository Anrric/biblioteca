...
<script>
    function validar2(){
    var nombre, apellidop, apellidom, edad, curp, contraseña, confirmacion, direccion, idu;
    ...
    if(idu ==""){
        alert("NO puede estar vacio el id del usuario");
        return false;
    }else if(nombre==""|| apellidop==""|| apellidom=="" || edad=="" || curp==""|| email=="" || contraseña=="" || confirmacion==""){
...
<main class="container row col-lg-6">
        ...
        <article>
            <br>
            <center>
            <h1 style="font-weight: bold">Actualizaci&oacuten de Usuarios</h1>
            </center>
            <br>
            <form action="modificandoU" onsubmit="return validar2();" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
              <div class="mb-3 row">
                <label for="idusuario" class="col-sm-5 col-form-label"style="font-weight: bold;">Id del usuario a actualizar:</label>
                <div class="col-sm-7">
                    <input type="number" class="form-control" id="idusuario" name="idusuario" min="1" max="20" required>
                </div>
            </div>
            <hr>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="curp" id="curp" name="curp" maxlength="19" required>
                </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                  <input type="password" class="form-control" id="contraseña" name="contraseña" maxlength="15" required>
                </div>
